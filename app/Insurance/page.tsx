...
const INSURANCE_SCHEMES = [
  {
    ...
    steps: ['बैंक जाएं या नेट बैंकिंग खोलें', 'PMJJBY के लिए आवेदन करें', 'फॉर्म भरें और नॉमिनी का नाम दें', '₹436 ऑटो डेबिट होगा जून में'],
  ...
  },
  {
    ...
    type: 'दुर्घटना बीमा',
    who: 'सभी बैंक खाताधारक',
    desc: 'सिर्फ ₹20/वर्ष में दुर्घटना में मृत्यु या पूर्ण विकलांगता पर ₹2 लाख। आंशिक विकलांगता पर ₹1 लाख।',
  ...
  },
  {
    ...
    claim: 'फसल नुकसान पर पूरा बीमित राशि',
  ...
  },
  {
    ...
    claim: 'अस्पताल में भर्ती पर ₹5 लाख तक मुफ्त',
  ...
  {
    id: 'ujjwala-bima',
    name: 'Pradhan Mantri Jeevan Jyoti + Suraksha Combo',
    icon: '💎',
    tag: 'कॉम्बो बीमा',
    tagColor: 'bg-indigo-600',
    premium: '₹456/वर्ष (दोनों मिलाकर)',
    cover: '₹4 लाख (₹2L + ₹2L)',
    age: '18-50 वर्ष',
    type: 'जीवन + दुर्घटना बीमा',
    who: 'सभी बैंक खाताधारक',
    desc: 'PMJJBY और PMSBY दोनों साथ लें। सिर्फ ₹456/वर्ष में ₹4 लाख का कवर।',
  ...
  },
  {
    ...
    premium: '3% (50% सब्सिडी के बाद 1.5%)',
    ...
    steps: ['नजदीकी पशु चिकित्सालय जाएं', 'पशु का स्वास्थ्य प्रमाण पत्र बनवाएं', 'बीमा कंपनी/बैंक में आवेदन करें', 'पशु की टैगिंग होगी'],
...
export default function InsurancePage() {
  ...
  const tags = ['all', 'जीवन बीमा', 'दुर्घटना बीमा', 'स्वास्थ्य बीमा', 'फसल बीमा', 'पशु बीमा', 'पेंशन बीमा']
  const filtered = filter === 'all' ? INSURANCE_SCHEMES : INSURANCE_SCHEMES.filter(s => s.type === filter)
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          {[['💰 प्रीमियम', selected.premium], ['🛡️ कवर', selected.cover], ['👥 आयु', selected.age], ['✅ क्लेम', selected.claim]].map(([k, v]) => (
            <div key={k} className="bg-white rounded-xl p-3 text-center">
              ...
              <div className="font-bold text-green-800 text-xs">{v}</div>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="bg-gradient-to-r from-green-700 to-green-900 text-white rounded-2xl p-5 mb-6 text-center">
        <h1 className="text-2xl font-bold mb-1">🛡️ सरकारी बीमा योजनाएं</h1>
      ...
      <div className="flex gap-2 flex-wrap mb-6">
        {tags.map(t => (
          <button key={t} onClick={() => setFilter(t)}
            className={`px-4 py-2 rounded-full text-sm font-medium transition ${filter===t ? 'bg-green-700 text-white' : 'bg-gray-100 text-gray-700 hover:bg-green-100'}`}>
            {t === 'all' ? 'सभी' : t}
          </button>
        ))}
      </div>
          ...
          <div key={s.id} onClick={() => setSelected(s)}
            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              <div className="bg-green-50 rounded-lg p-2 text-center">
                <div className="text-xs text-gray-500">प्रीमियम</div>
                <div className="text-green-700 font-bold text-xs">{s.premium}</div>
              </div>
              <div className="bg-blue-50 rounded-lg p-2 text-center">
                <div className="text-xs text-gray-500">कवर</div>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mt-6 text-xs text-gray-600 text-center">
        ⚠️ बीमा की शर्तें बदल सकती हैं। आवेदन से पहले अपने बैंक या बीमा कंपनी से पुष्टि करें।
      </div>
    </div>
  )
}
