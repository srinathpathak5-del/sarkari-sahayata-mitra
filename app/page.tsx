...
// CHANGE: Products at TOP (with new Sarkari Kaam image), then Hero, then Videos
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-b from-orange-50 to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
            ...
            {/* CARD 4 - SARKARI KAAM with NEW IMAGE */}
            <Link href="/sarkari-kaam" className="group">
              <div className="bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all hover:-translate-y-2 h-full">
                <div className="aspect-[16/10] relative overflow-hidden bg-gray-100">
                  <img src="/sarkari-kaam-creative.png" alt="सरकारी काम" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="p-5 sm:p-6">
